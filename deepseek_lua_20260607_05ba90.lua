...
-- Custom UI - No External Libraries Required
...
local function createToggle(parent, text, callback)
    ...
    toggleBtn.Position = UDim2.new(0.85, 0, 0.125, 0)
...
local function createSlider(parent, text, min, max, default, callback)
    ...
    local function updateSlider(newVal)
        ...
        knob.Position = UDim2.new(percent, -7.5, 0, -5)
    ...
    knob.MouseButton1Down:Connect(function()
        ...
        moveConn = mouse.Move:Connect(function()
            ...
            local frameWidth = slider.AbsoluteSize.X
            local percent = math.clamp((mouseX - framePos) / frameWidth, 0, 1)
...
-- Create Tabs
local currencyTab = createTab("💰", Color3.fromRGB(0, 150, 100))
local bypassTab = createTab("🛡️", Color3.fromRGB(200, 100, 50))
local exploitTab = createTab("💀", Color3.fromRGB(200, 50, 50))
local teleportTab = createTab("📍", Color3.fromRGB(50, 100, 200))
local statsTab = createTab("⚙️", Color3.fromRGB(150, 100, 200))
local utilTab = createTab("🛠️", Color3.fromRGB(100, 150, 100))
local infoTab = createTab("ℹ️", Color3.fromRGB(100, 100, 150))
...
-- 💰 CURRENCY TAB
-- ============================================
createLabel(currencyTab, "━━━━━━ MONEY & DIAMONDS ━━━━━━")
...
-- 🛡️ BYPASS TAB
-- ============================================
createLabel(bypassTab, "━━━━━ ANTI-CUFF & RESTRAINTS ━━━━━")
...
createLabel(bypassTab, "━━━━━ AUTO FEATURES ━━━━━")
...
-- 💀 EXPLOIT TAB
-- ============================================
createLabel(exploitTab, "━━━━━ POWERFUL EXPLOITS ━━━━━")

createButton(exploitTab, "👮 STAFF CHECK", function()
    local staffList = {}
    for _, p in ipairs(game.Players:GetPlayers()) do
        if p.Team and (p.Team.Name == "Staff" or p.Team.Name == "Admin") then
...
-- 📍 TELEPORT TAB
-- ============================================
createLabel(teleportTab, "━━━━━ LOCATION TELEPORTS ━━━━━")
...
createLabel(teleportTab, "━━━━━ CUSTOM TELEPORTS ━━━━━")
...
-- ⚙️ STATS TAB
-- ============================================
createLabel(statsTab, "━━━━━ MOVEMENT MODIFIERS ━━━━━")
...
createLabel(statsTab, "━━━━━ RESET ━━━━━")

createButton(statsTab, "🔄 RESET WALKSPEED", function()
    local char = player.Character
    if char and char:FindFirstChildOfClass("Humanoid") then
...
createButton(statsTab, "🔄 RESET JUMP POWER", function()
    local char = player.Character
    if char and char:FindFirstChildOfClass("Humanoid") then
...
-- 🛠️ UTILITIES TAB
-- ============================================
createLabel(utilTab, "━━━━━ TOOLS ━━━━━")

createButton(utilTab, "🔧 BTOOLS", function()
...
-- ℹ️ INFO TAB
-- ============================================
createLabel(infoTab, "━━━━━ ABOUT ━━━━━")
createLabel(infoTab, "🔥 CUSA ARMY - ULTIMATE EXPLOIT")
createLabel(infoTab, "💀 Created for CUSA Army")
createLabel(infoTab, "⚡ All features are OP and working")
createLabel(infoTab, "🎮 Drag the window anywhere")
createLabel(infoTab, "❌ Click X to close")
...
local function updateCanvas()
    ...
    for _, child in ipairs(scrollFrame:GetChildren()) do
        if child:IsA("Frame") and child.Visible then
            ...
            if layout then
                totalHeight = math.max(totalHeight, layout.AbsoluteContentSize.Y)
            end
        end
    end
...
print("CUSA ARMY - Ultimate Exploit Loaded!")